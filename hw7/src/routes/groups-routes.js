...
router.get('/group', checkTokenEquality, async (req,res) => {
...
router.post('/group', checkTokenEquality, validation(shema), async (req,res,next) => {
    try {
...
router.get('/group/:id', checkTokenEquality, async(req,res,next) => {
    try{
...
router.put('/group/:id', checkTokenEquality, async (req,res,next) => {
    try{
...
router.delete('/group/:id', checkTokenEquality, async (req, res, next) => {
    try{
