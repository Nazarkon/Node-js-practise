...
router.get('/userGroup', checkTokenEquality, async function (req, res, next) {
    try {
...
router.post('/userGroup', checkTokenEquality, async function (req, res, next) {
    try {
...
router.delete('/userGroup/:userId', checkTokenEquality, async function (req, res, next) {
    try {
