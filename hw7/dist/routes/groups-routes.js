...
var checkTokenEquality = require('../helper/authenticate');
...
router.get('/group', checkTokenEquality, async function (req, res) {
...
router.post('/group', checkTokenEquality, validation(shema), async function (req, res, next) {
    try {
...
router.get('/group/:id', checkTokenEquality, async function (req, res, next) {
    try {
...
router.put('/group/:id', checkTokenEquality, async function (req, res, next) {
    try {
...
router.delete('/group/:id', checkTokenEquality, async function (req, res, next) {
    try {
