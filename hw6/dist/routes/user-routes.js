...
router.get('/users', checkTokenEquality, async function (req, res, next) {
...
router.get('/user/:id', checkTokenEquality, async function (req, res, next) {
    try {
...
router.put('/user/:id', checkTokenEquality, validation(schema), async function (req, res) {
    try {
...
router.delete('/user/:id', checkTokenEquality, async function (req, res, next) {
    try {
